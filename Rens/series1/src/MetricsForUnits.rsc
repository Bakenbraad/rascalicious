...
public rel[str,loc] riskPerUnitSize(loc projectloc){
...
public rel[str, loc] riskPerUnitCC(loc projectloc) {
...
public void printUnitResults(loc projectloc){
	...
	println("\nComplexity Rank: <calcRelativeRisk(getCategorizedRisk(riskPerUnitCC(projectloc)), totalPureLines)>");
	println("\nUnit Size Rank: <calcRelativeRisk(getCategorizedRisk(riskPerUnitSize(projectloc)), totalPureLines)>");
	return;
}